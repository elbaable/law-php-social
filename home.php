...
<html>
	...
	<head>
		<title>Welcome  To My Profile - Sign up, Log in, Post </title>
...
<?php include ('session.php');?>
	...
	<div id="header">
		<div class="head-view">
			<ul>
				<li><a href="home.php" title="My Profile"><b>My profile</b></a></li>
				<li></li>
				<li></li>
				<li></li>
				<li></li>
...
<?php
	include("includes/database.php");
			$comment=mysqli_query($conn, "SELECT * from comments where post_id='$post_id' order by post_id DESC") or die(mySQL_error());
